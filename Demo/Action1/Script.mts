Browser("Advantage Shopping").Page("Advantage Shopping").Link("SPEAKERS Shop Now").Click @@ script infofile_;_ZIP::ssf1.xml_;_
...
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("WebElement").Check CheckPoint("WebElement") @@ script infofile_;_ZIP::ssf4.xml_;_
...
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("WebElement_3").Click


'Browser("Advantage Shopping").Page("Advantage Shopping").Link("5").Click @@ script infofile_;_ZIP::ssf7.xml_;_
